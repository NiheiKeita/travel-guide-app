import { useSuwakoView } from './hooks'
...
export const SuwakoView = React.memo<Props>(function SuwakoView({
    travel,
}) {
    console.log(travel)
    const { data, setData, post, processing, errors, reset, submit } = useSuwakoView()
                                ...
                                {scheduleGroup?.schedules?.map((schedules, i: number) => (
                                    ...
                                    >
                                        ...
                                        <div className="flex items-center">
                                            ...
                                            {(schedules.modal_id !== null && schedules.modal_id !== undefined) && (
                                                <img
